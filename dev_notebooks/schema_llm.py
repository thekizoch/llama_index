...
class SchemaLLMPathExtractor(TransformComponent):
    ...
    def __init__(
        ...
        if kg_schema_cls is None:
            ...
            print(f"type of entity_cls: {type(entity_cls)}")
    ...
    async def _aextract(self, node: BaseNode) -> BaseNode:
        ...
        print(f"base model cls : {self.kg_schema_cls}")
        print(f"schema of base model cls:\n{self.kg_schema_cls.schema()}")
        ...
        try:
            ...
            print(f"entities predicted: {kg_schema}")
            print(f"type of entities: {type(kg_schema)}")
